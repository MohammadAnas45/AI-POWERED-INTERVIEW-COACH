                            ...
                            <div className="flex gap-4 pt-6 border-t border-white/5 mt-6">
                                {formData.github_url && (
                                    <a 
                                        ...
                                        className="flex-1 flex items-center justify-center gap-2 p-3 bg-white/5 rounded-xl border border-white/10 text-xs text-slate-400 hover:text-white hover:bg-slate-800 transition-all group"
                                    >
