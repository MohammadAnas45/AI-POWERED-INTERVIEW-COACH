...
import { Timer, Send, AlertCircle, CheckCircle, Mic, MicOff, Type } from 'lucide-react';
                        ...
                        {inputMode === 'text' ? (
                            ...
                            <div className="relative w-full h-64 bg-slate-900 border border-slate-700 rounded-2xl p-6 flex flex-col items-center justify-center">
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all shadow-lg ${listening
                                ...
                                {!browserSupportsSpeechRecognition && (
                                    <p className="text-red-400 text-sm mt-4">Your browser does not support speech recognition.</p>
                                )}
                            </div>
                        )}
                    </div>
